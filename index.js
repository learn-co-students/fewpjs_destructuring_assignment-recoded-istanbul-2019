...
const [moo, neigh, baa, oink, cluck] = 'cow horse sheep pig chicken'.split(' '); console.log(moo)
// 2. Bolt the horse wandered off, so just give us four animals, and let's name them Bessie, Dolly, Babe, and Little.
const [Bessie, ,Dolly, Babe, Little] = 'cow horse sheep pig chicken'.split(' '); console.log(Bessie)
...
const [black_and_white, ,black, pink, ] = 'cow horse sheep pig chicken'.split(' '); console.log(black_and_white)
// Arrays
