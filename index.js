...
let animals5 = farmAnimals.split(' ');
let [moo, neigh , baa, oink , cluck] = animals5;

// 2. Bolt the horse wandered off, so just give us four animals, and let's name them Bessie, Dolly, Babe, and Little.
let animals4 = 'cow sheep pig chicken'.split(' ');
let [Bessie , Dolly , Babe , Little] = animals4;
...
let animals3 = 'cow sheep pig'.split(' ')
let [black_and_white ,black ,pink] = animals3;
