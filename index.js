...
const [Bessie, Dolly, Babe, Little] = [animals[0], animals[2],  animals[3], animals[4]]
...
const [black_and_white, black, pink] = [animals[0], animals[2], animals[3]]
// Arrays
...
const [r, o, y, g, b, v] = [colors[0], colors[1], colors[2], colors[3], colors[4], colors[6]]
...
const album = k_muppet.k_album.the_muppet_movie
const [song_2] = [album.song_2]
const [song_4] = [album.song_4]
