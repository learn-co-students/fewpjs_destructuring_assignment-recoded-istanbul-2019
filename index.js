...
let [moo,neigh,baa,oink,cluck] = 'cow horse sheep pig chicken'.split(' '); 

// 2. Bolt the horse wandered off, so just give us four animals, and let's name them Bessie, Dolly, Babe, and Little.
let [Bessie, , Dolly,Babe,Little]='cow horse sheep pig chicken'.split(' ');
...
let [black_and_white, , black,pink, ,] = 'cow horse sheep pig chicken'.split(' ');
// Arrays
