...
const {k_color, song_2, song_4, k_job, k_partner} ={k_color : k_muppet.k_color , song_2:k_muppet.k_album.the_muppet_movie.song_2 , song_4:k_muppet.k_album.the_muppet_movie.song_4, k_job :k_muppet.k_job, k_partner: k_muppet.k_partner};